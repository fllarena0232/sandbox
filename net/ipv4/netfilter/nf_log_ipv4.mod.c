...
__attribute__((section("__versions"))) = {
	...
	{ 0x7973218d, __VMLINUX_SYMBOL_STR(nf_log_dump_packet_common) },
	{ 0xd4961de, __VMLINUX_SYMBOL_STR(nf_log_buf_open) },
	{ 0x54dce828, __VMLINUX_SYMBOL_STR(init_net) },
	{ 0xe23f4a4f, __VMLINUX_SYMBOL_STR(nf_log_set) },
	{ 0x23ae8d8f, __VMLINUX_SYMBOL_STR(nf_log_unset) },
	{ 0x2e5810c6, __VMLINUX_SYMBOL_STR(__aeabi_unwind_cpp_pr1) },
	{ 0x78cdd651, __VMLINUX_SYMBOL_STR(nf_log_dump_tcp_header) },
	{ 0xd66b141c, __VMLINUX_SYMBOL_STR(nf_log_dump_sk_uid_gid) },
	{ 0xfe9262b6, __VMLINUX_SYMBOL_STR(nf_log_dump_udp_header) },
...
MODULE_INFO(srcversion, "34B46F50443F1971CB2F574");
