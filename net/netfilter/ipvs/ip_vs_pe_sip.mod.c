...
__attribute__((section("__versions"))) = {
	...
	{ 0xd5103bcd, __VMLINUX_SYMBOL_STR(unregister_ip_vs_pe) },
	{ 0xb7c1c1a3, __VMLINUX_SYMBOL_STR(register_ip_vs_pe) },
	...
	{ 0xc2d8cb64, __VMLINUX_SYMBOL_STR(ip_vs_new_conn_out) },
