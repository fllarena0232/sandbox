...
__attribute__((section("__versions"))) = {
	...
	{ 0x155b8e9e, __VMLINUX_SYMBOL_STR(snd_timer_global_new) },
	...
	{ 0x9718a6f5, __VMLINUX_SYMBOL_STR(snd_timer_global_register) },
	{ 0x82dd6e42, __VMLINUX_SYMBOL_STR(hrtimer_try_to_cancel) },
	{ 0x2ddb70ed, __VMLINUX_SYMBOL_STR(snd_timer_global_free) },
};
...
MODULE_INFO(srcversion, "D91FB69A9CFA2F9450FF4F9");
